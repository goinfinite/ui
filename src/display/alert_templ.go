...
func Alert(componentSettings AlertSettings) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		alertContentClasses := "flex-1 min-w-0"
		alertTitleClasses := "font-semibold"
		alertDescriptionClasses := "mt-1"
		...
		case AlertVariationSuccess:
			...
			alertVariationBgColor = "bg-emerald-50/10"
		...
		case AlertVariationWarning:
			...
			alertVariationBgColor = "bg-yellow-50/10"
		...
		if alertAlpineState != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 222, Col: 28}
			}
			...
			if componentSettings.DisplayTimeoutSeconds > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 225, Col: 166}
				}
		...
		if componentSettings.TitleLeftIcon != "" || componentSettings.TitleLeftIconTwoWayStatePath != "" {
			...
			if componentSettings.TitleLeftIconTwoWayStatePath != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 236, Col: 72}
				}
		...
		if componentSettings.ContentHtml != nil {
			...
			if componentSettings.Title != "" || componentSettings.TitleOneWayStatePath != "" {
				...
				if componentSettings.TitleOneWayStatePath != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 261, Col: 54}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 264, Col: 31}
				}
			...
			if componentSettings.Description != "" || componentSettings.DescriptionOneWayStatePath != "" {
				var templ_7745c5c3_Var17 = []any{descriptionClasses}
				...
				if componentSettings.DescriptionOneWayStatePath != "" {
					...
					templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(componentSettings.DescriptionOneWayStatePath)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 280, Col: 60}
					}
				...
				templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(componentSettings.Description)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 283, Col: 37}
				}
		...
		if componentSettings.TitleRightIcon != "" || componentSettings.TitleRightIconTwoWayStatePath != "" {
			...
			var templ_7745c5c3_Var21 = []any{"ph-duotone " + componentSettings.TitleRightIcon + " " + iconClasses}
			...
			if componentSettings.TitleRightIconTwoWayStatePath != "" {
				...
				templ_7745c5c3_Var23, templ_7745c5c3_Err = templ.JoinStringErrs("'" + componentSettings.TitleRightIconTwoWayStatePath + "'")
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/display/alert.templ`, Line: 293, Col: 73}
				}
